...
export const CARDS: Card[] = [
  ...
  // {
  //   id: 'card-22',
  //   title: '世界最高峰の“学び直し”留学',
  //   description: '研究者・教授陣と学ぶ。自分の視野を拡張する',
  //   cost: 150_000_000,
  //   category: 'experience',
  //   imageUrl: `${import.meta.env.BASE_URL}images/image_22.webp`,
  // },
  {
    id: 'card-23',
    title: 'インフラ（道路・港・通信）への長期投資',
  ...
  // {
  //   id: 'card-28',
  //   title: '高配当株＋債券の“生活費ポートフォリオ”',
  //   description: '毎年安定して使えるキャッシュフローを作る',
  //   cost: 4_000_000_000,
  //   category: 'asset',
  //   imageUrl: `${import.meta.env.BASE_URL}images/image_28.webp`,
  // },
  {
    id: 'card-29',
    title: '国内外REITで“家賃収入”を作る',
  ...
  {
    id: 'card-30',
    title: '金・コモディティで守りを固める',
    description: 'インフレや有事に備える“守りの資産”を積む',
    cost: 1_200_000_000,
    category: 'asset',
    imageUrl: `${import.meta.env.BASE_URL}images/image_30.webp`,
  },
  {
    id: 'card-31',
    title: '教育・奨学金の基金（エンダウメント）',
    description: '元本を守りつつ運用して、毎年支援を出し続ける',
    cost: 800_000_000,
    category: 'asset',
    imageUrl: `${import.meta.env.BASE_URL}images/image_31.webp`,
  },
]
